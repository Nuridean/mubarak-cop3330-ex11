...
public class App {
    public static void main(String[] args){
        ...
        double euro = Double.parseDouble(euroAmount);
        double ex = Double.parseDouble(exRate);
        double converter = euro * ex;

        String output = euro + " euros at an exchange rate of " + ex + " is\n" + converter + " U.S dollars.";
